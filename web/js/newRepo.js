...
function createNewRepo() {
    ...
    if (RepoNames.includes(name2.value.toLowerCase())) {return}
    else if (name2.value == "") {return}
    if (document.getElementById("beschreibung").value == "") {return}
...
document.getElementById("name").addEventListener("input", function () {
    name2 = document.getElementById("name")
    if (RepoNames.includes(name2.value.toLowerCase())) {document.getElementById("name").style.background = "#5d1717"}
    else if (name2.value == "") {document.getElementById("name").style.background = "#5d1717"}
    else {document.getElementById("name").style.background = ""}
})

document.getElementById("beschreibung").addEventListener("input", function () {
    name2 = document.getElementById("beschreibung")
    if (name2.value == "") {document.getElementById("beschreibung").style.background = "#5d1717"}
    else {document.getElementById("beschreibung").style.background = ""}
})